 ...
 */
public class TrendingTVShowRepository {
    private ApiService apiService;

    public TrendingTVShowRepository() {
        apiService = RetrofitClient.getRetrofit().create(ApiService.class);
    }

    public LiveData<TvShowResponse> getTrendingTVShows(int page, String apiKey) {
        MutableLiveData<TvShowResponse> data = new MutableLiveData<>();
        apiService.getTrendingTVShows(apiKey, page).enqueue(new Callback<TvShowResponse>() {
            @Override
